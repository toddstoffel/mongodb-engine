...
// Include MariaDB headers only when building as plugin
#ifdef MYSQL_SERVER
#include "my_global.h"
#include "field.h"
#else
// Standalone mode - define required types
typedef unsigned char uchar;
typedef unsigned long ha_rows;
struct TABLE;

// Define minimal field types for standalone compilation
enum enum_field_types {
  ...
  MYSQL_TYPE_TYPED_ARRAY, MYSQL_TYPE_INVALID=243,
  MYSQL_TYPE_BOOL=244, MYSQL_TYPE_JSON=245,
